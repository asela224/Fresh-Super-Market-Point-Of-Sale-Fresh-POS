...
public class AdminCashierController {
    ...
    void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        ...
        col_item_age = new TableColumn<Cashier, String>("Birthday");
        ...
        col_item_phone.setStyle("-fx-font-size: 18; -fx-alignment: CENTER");
    ...
    void onBtAddAction(ActionEvent event) throws SQLException {
    	...
    	if(tf_name.getText().equals("") || tf_id.getText().equals("") || tf_age.getText().equals("") || 
    	   ...
    	   tf_password.getText().equals("")|| tf_date_created.getText().equals("")  || tf_age.getText().matches(".*[a-zA-Z]+.*")   ||
    	   tf_phone.getText().matches(".*[a-zA-Z]+.*") || tf_phone.getText().length() < 9 || 	!tf_email.getText().contains("mail.com") ||
    	...
    	try {
    		...
    		System.out.println("Insert Query started");
    	String addQuery = "INSERT INTO `cashier` (`id`, `name`, `dob`, `gender`, `address`, `phone`, `email`, `password`, `date created`) VALUES ( "+id+", '"+name+"', '"+age+"', '"+gender+"','"+addr+"','"+ph+"','"+mail+"','"+pw+"','"+datecreated+"')";
    	new DBInitialize();
    ...
    void onbtUpdateAction(ActionEvent event) throws SQLException {
    	...
    	if(tf_name.getText().equals("") || tf_id.getText().equals("") || tf_age.getText().equals("") || tf_addr.getText().equals("") || tf_phone.getText().equals("") || tf_email.getText().equals("") || tf_password.getText().equals("") 
    			|| tf_date_created.getText().equals("")  || tf_phone.getText().matches(".*[a-zA-Z]+.*") || tf_phone.getText().length() < 9 || 	!tf_email.getText().contains("mail.com") || !tf_email.getText().contains("@"))  {
    	...
    	String updateQuery = "UPDATE `cashier` SET `name`='"+name+"',`dob`='"+age+"',`gender`='"+gender+"',"
